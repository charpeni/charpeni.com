...
>
> <del>
>   Oxlint currently has a performance cliff when you have{' '}
>   <strong>
>     4+ JS plugin <em>names</em>
>   </strong>{' '}
>   active simultaneously, going from ~2.5s to ~38s in our case. We worked
>   around it by keeping ourselves to 3 plugins. Worth knowing if you're
>   planning to lean heavily on JS plugins.
> </del>
>
