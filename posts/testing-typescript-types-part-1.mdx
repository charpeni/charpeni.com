...
> ℹ️ If you're not interested in the preamble and want to jump directly to the advanced solutions, you can [go to part 2 right away](/blog/testing-typescript-types-part-2).
