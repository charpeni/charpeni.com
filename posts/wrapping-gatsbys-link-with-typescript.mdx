...
From there, you can always use this custom drop-in `<Link>` component instead of Gatsby's one while keeping the typing and don't even have to worry about external links anymore.
