...
```typescript twoslash
const data = { a: 'value-a', b: 'value-b', c: 'value-c' } as const;
// ---cut---
...
type Keys = (keyof typeof data)[] & {};
// ---cut---
const typedKeys = Object.keys(data) as Keys; // ^? const typedKeys: ("a" | "b" | "c")[]
```
...
```typescript twoslash
// @filename: node_modules/type-fest/index.d.ts
