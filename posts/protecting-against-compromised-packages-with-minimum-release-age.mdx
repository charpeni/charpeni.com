...
> [!NOTE]
> Each package manager uses a different unit: pnpm uses minutes, Yarn uses duration strings (`1d`), npm uses days, and Bun uses seconds. Double-check the value when copying configurations between projects.
